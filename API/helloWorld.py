...
def main():
	...
	find_btn = document.getElementById("findBtn")
	find_btn.addEventListener("click", GetTweetByKeywords(keywords))
...
def GetTweetByKeywords(keywords):
	limit = 300
	...
	data_frame = pd.DataFrame(data, columns = columns)	
	document.getElementById("returnTLB").innerHTML() = data_frame.to_html(classes='table table-stripped')
	# print(data_frame)